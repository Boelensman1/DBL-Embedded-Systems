...
timerInterrupt:      BRS timerManage                              ;timerManage()
                     ...
                     LOAD R2 initial                              ;$temp2=getFuncLocation('initial')
                     ADD R1 R2                                    ;$temp+=$temp2
...
aborted:             PUSH R3                                      ;$startStop = getButtonPressed(0)
                     ...
                     CMP R1 1                                     ;if ($startStop == 1) {
                     BEQ conditional21
return21:                                                         ;unset($startStop)
                     BRA aborted                                  ;aborted()
                     
                                                                  ;if ($startStop == 1) {
conditional21:       LOAD R2 9                                    ;$temp = 9
                     STOR R2 [GB +outputs + HBRIDGE0]             ;storeData($temp, 'outputs', HBRIDGE0)
                     LOAD R4 0                                    ;$state = 0
                     PUSH R5                                      ;display($state, "leds2", "")
                     LOAD R5 -16
